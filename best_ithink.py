#!/usr/bin/env python3
"""
localization_v14.launch.py  [v10.17]
=====================================
...
def generate_launch_description():
    ...
    cox_registration_node = Node(
        ...
        parameters=[{
            ...
            "initialpose_cooldown_s": 5.0,             # [FIX M] /initialpose max 1/5s
            ...
            "center_circle_filter_radius_m": 1.6,      # [FIX J] filter world-space r=1.6m
        }]
    )
